            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                ...
                <li class="nav-item">
                    <a href="{{ route('daily-lights.index') }}"
                        class="nav-link {{ request()->routeIs('daily-lights.*') || request()->routeIs('comments.index') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('comment-moderation.index') }}"
                        class="nav-link {{ request()->routeIs('comment-moderation.index') && !request('tab') ? 'active' : '' }}">
                        <i class="nav-icon bi bi-chat-square-text"></i>
                        <p>{{ __('common.comment_moderation') }}</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('subscription.index') }}"
                        ...
                        <p>{{ __('common.subscription_details') }}</p>
                    </a>
                </li>
                {{-- <li class="nav-item">
                    <a href="{{ route('comment-moderation.index') }}?tab=reported"
                        class="nav-link {{ request()->routeIs('comment-moderation.index') && request('tab') === 'reported' ? 'active' : '' }}">
                        <i class="nav-icon bi bi-flag"></i>
                        <p>{{ __('common.reported_comments') }}</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('comment-moderation.index') }}?tab=hidden"
                        class="nav-link {{ request()->routeIs('comment-moderation.index') && request('tab') === 'hidden' ? 'active' : '' }}">
                        <i class="nav-icon bi bi-shield-x"></i>
                        <p>{{ __('common.hidden_comments') }}</p>
                    </a>
                </li> --}}
            </ul>
        </nav>
