@extends('layouts.app')
@section('title', __('daily_lights.create_daily_light'))
...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0">{{ __('daily_lights.create_daily_light') }}</h3></div>
                <div class="col-sm-6">
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form action="{{ route('daily-lights.store') }}" method="POST" enctype="multipart/form-data" id="dailyLightForm">
                @csrf
...
<div class="dl-overlay-loader" id="dlOverlayLoader">
    ...
    <div class="loader-text" id="dlLoaderText">{{ __('daily_lights.saving') }}</div>
</div>
@endsection
